"""Whole Body Tracking observation presets for the Walker robot."""
...
walker_30dof_wbt_observation = ObservationManagerCfg(
    groups={
...
walker_30dof_wbt_observation_w_object = ObservationManagerCfg(
    groups={
        "actor_obs": actor_obs_shared,
        "critic_obs": ObsGroupCfg(
            concatenate=True,
...
__all__ = ["walker_30dof_wbt_observation", "walker_30dof_wbt_observation_w_object"]
