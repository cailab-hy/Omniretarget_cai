"""Whole Body Tracking randomization presets for the Walker robot."""
...
walker_30dof_wbt_randomization = RandomizationManagerCfg(
    setup_terms={**base_setup_terms},
    reset_terms={**base_reset_terms},
    step_terms={**base_step_terms},
)

walker_30dof_wbt_randomization_w_object = RandomizationManagerCfg(
    setup_terms={
        **base_setup_terms,
        **object_state_dr_at_setup,
    },
...
__all__ = ["walker_30dof_wbt_randomization", "walker_30dof_wbt_randomization_w_object"]
