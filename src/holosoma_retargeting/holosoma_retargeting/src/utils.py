...
def preprocess_motion_data(
    ...
    Args:
        ...
        object_name (str): Name of the object (e.g., "suitcase", "largebox").
        robot_type (str): Type of robot (e.g., "walker", "g1").
    ...
    if object_poses is not None:
        ...
        # # Additional z offset for suitcase on walker
        # if object_name == "suitcase" and robot_type == "walker":
        #     object_poses[:, -1] -= 0.3
